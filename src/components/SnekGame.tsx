...
interface SnekGameProps extends BaseGameProps {}
...
const SnekGame: React.FC<SnekGameProps> = ({ onGameComplete, onPlayAgain, difficulty = 1 }) => {
  ...
  // Secret phrase
  const secretPhrase = "thank you snek";
